...
if (!$authenticated) {
    ...
    $statement = $db_handle->prepare("INSERT INTO incrementalproxy.vw_domains_per_user (username, domain, status, motivation) VALUES (:username, :domain, 'limbo', :motivation);");
